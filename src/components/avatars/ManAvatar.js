...
function ManAvatar(props) {
    ...
    useEffect(()=>{
        if(props.shirtColor.color1 !== "" && props.shirtColor.color2 !== ""){
            setShirtColor({
    ...
    return (
        <>
        <svg width="135" height="136" viewBox="0 0 135 136" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={props.onClick}>
        ...
        <path d="M78.6373 96.1C78.5373 96.1 78.5373 96 78.4373 96C76.6373 99.5 72.5373 102 67.7373 102C62.9373 102 58.8373 99.5 57.0373 96C56.9373 96 56.9373 96.1 56.8373 96.1C49.1373 100.1 40.9373 100.7 44.3373 138.9C65.7373 138.9 69.5373 138.9 90.9373 138.9C94.5373 100.7 86.3373 100.1 78.6373 96.1Z" fill={shirtColor.color1}/>
        <path d="M78.6372 96.1C78.5372 96.1 78.5372 96 78.4372 96C77.8372 97.2 76.9372 98.2 75.8372 99.1C78.2372 98.9 80.5372 98.6 82.7372 98.1C81.4372 97.4 80.0372 96.8 78.6372 96.1Z" fill={shirtColor.color2}/>
        <path d="M57.0373 96C56.9373 96 56.9373 96.1 56.8373 96.1C55.4373 96.8 54.0373 97.4 52.7373 98.2C54.9373 98.6 57.2373 98.9 59.5373 99.2C58.5373 98.2 57.6373 97.2 57.0373 96Z" fill={shirtColor.color2}/>
        <path d="M90.037 107.3C89.537 105.8 89.037 104.6 88.437 103.5C84.037 105.1 77.137 106.4 67.937 106.4C58.537 106.4 51.537 105 47.137 103.4C46.537 104.4 45.937 105.7 45.437 107.1C51.237 109.3 59.637 110.5 67.937 110.5C76.037 110.5 84.237 109.4 90.037 107.3Z" fill={shirtColor.color2}/>
        <path d="M91.6373 117.6C91.5373 116 91.4373 114.6 91.2373 113.2C87.3373 115.3 79.4373 117.4 67.9373 117.4C56.0373 117.4 47.9373 115.2 44.1373 113C43.9373 114.3 43.8373 115.8 43.7373 117.3C49.5373 120 58.7373 121.4 67.9373 121.4C76.8373 121.5 85.8373 120.2 91.6373 117.6Z" fill={shirtColor.color2}/>
        <path d="M91.6373 128.4C91.7373 126.8 91.7373 125.2 91.7373 123.8C88.0373 126 79.9373 128.3 67.7373 128.3C55.2373 128.3 46.9373 125.9 43.4373 123.6C43.4373 125.1 43.4373 126.6 43.5373 128.3C49.3373 131 58.5373 132.4 67.7373 132.4C76.8373 132.4 85.8373 131.1 91.6373 128.4Z" fill={shirtColor.color2}/>
        <path d="M44.0374 134.9C44.1374 136.2 44.2374 137.5 44.3374 138.9C50.6374 138.9 55.3374 138.9 59.4374 138.9C52.0374 138.2 46.8374 136.5 44.0374 134.9Z" fill={shirtColor.color2}/>
        <path d="M90.9374 138.9C91.0374 137.6 91.1373 136.3 91.2373 135.1C88.3373 136.6 83.2374 138.2 76.0374 138.9C80.1374 138.9 84.8374 138.9 90.9374 138.9Z" fill={shirtColor.color2}/>
